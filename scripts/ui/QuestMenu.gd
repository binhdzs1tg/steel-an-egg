...
func _add_quest_row(q: Dictionary, state: Dictionary, available: bool, complete: bool, claimed: bool) -> void:
	...
	row.custom_minimum_size = Vector2(860, 100)
	...
	name_box.offset_right = -12
	name_box.offset_top = 6
	...
	obj_lbl.offset_left = 12
	obj_lbl.offset_right = -12
	obj_lbl.offset_top = 50
	...
	reward_lbl.offset_left = 12
	reward_lbl.offset_right = -12
	reward_lbl.offset_top = 70
	...
	if complete and not claimed:
		...
		claim_btn.offset_left = 740
		claim_btn.offset_top = 6
		claim_btn.offset_right = 840
		claim_btn.offset_bottom = 38
